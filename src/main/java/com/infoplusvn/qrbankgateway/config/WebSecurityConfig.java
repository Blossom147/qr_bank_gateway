    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                ...
                .authorizeRequests().antMatchers(
                        ...
                        "/infogw/qr/v1/getQRByid/{id}",
                        "/infogw/qr/v1/updateQR",
                        "/infogw/qr/v1/updateUserDetails",
                        "/infogw/qr/v1/transactionSearch",
                        "/infogw/qr/v1/transactionCount",
                        "/infogw/qr/v1/qrSearch",
                        "/infogw/qr/v1/qrCodeCount",
                        "/infogw/qr/v1/getAllQR",
                        "/infogw/qr/v1/deleteQr/{id}",
                        "/infogw/qr/v1/deleteUser/{username}",
                        "/infogw/qr/v1/adminGetUser/{username}",
                        "/infogw/qr/v1/getRole/{userName}",
                        "/infogw/qr/v1/getUser/{userName}",
                        "/infogw/qr/v1/update/{userName}",
                        "/infogw/qr/v1/getQRByUsername/{username}",
                        "/infogw/qr/v1/transactions",
                        "/infogw/qr/v1/transactions/{transaction_id}",
                        "/infogw/qr/v1/getByid/{id}",
