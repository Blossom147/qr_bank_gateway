...
//    List<QRCodeEntity> findAllByCreatedUserAndEnabled(@Param("createdUser") String createdUser);
    ...
    @Query("SELECT new com.infoplusvn.qrbankgateway.dto.common.QrCodeDTORoleUser(t.qrId,t.qrName,t.createdUser,t.qrType,t.trnDt,t.customerName,t.text,t.qrImage,t.qrThemeImage,t.updateOn) from QRCodeEntity t where t.createdUser =:createdUser and t.enabled = true ORDER BY t.updateOn DESC")
    ...
    @Query("SELECT new com.infoplusvn.qrbankgateway.dto.common.QrCodeDTORoleUser(t.qrId,t.qrName,t.createdUser,t.qrType,t.trnDt,t.customerName,t.text,t.qrImage,t.qrThemeImage,t.updateOn) from QRCodeEntity t where t.qrId =:qrId ")
    QrCodeDTORoleUser getQrDTOById(@Param("qrId") Long qrId);

    @Query("SELECT new com.infoplusvn.qrbankgateway.dto.common.QrCodeDTORoleUser(t.qrId,t.qrName,t.createdUser,t.qrType,t.trnDt,t.customerName,t.text,t.qrImage,t.qrThemeImage,t.updateOn) from QRCodeEntity t where t.createdUser =:createdUser and t.enabled = false ORDER BY t.updateOn DESC")
