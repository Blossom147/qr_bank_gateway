...
public class PaymentConstant {
    ...
    public static final String API_URL_RESPONSE_NAPAS = "http://localhost:8082/infogw/qr/v1/issuer/payment";
    public static final String API_URL_SENT_TO_CORE = "http://localhost:8082/infogw/qr/v1/issuerbankPayment";
