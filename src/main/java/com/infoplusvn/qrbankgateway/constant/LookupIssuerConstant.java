...
public class LookupIssuerConstant {
    ...
    public static final String API_URL_RESPONSE_NAPAS = "http://localhost:8082/infogw/qr/v1/issuer/lookup";
    public static final String API_URL_SENT_TO_CORE = "http://localhost:8082/infogw/qr/v1/issuerbankLookup";
    public static final String API_URL_SENT_TO_NAPAS = "http://localhost:8082/issuerbank/qr/v1/payment/sentNapas";
}
